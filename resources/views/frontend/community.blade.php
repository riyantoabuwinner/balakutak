...
@push('title'){{ __('Pengabdian') }} - @endpush
    ...
    <div class="container py-4 position-relative z-1">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-2 text-white-50">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">{{ __('Pengabdian Masyarakat') }}</li>
            </ol>
        </nav>
        <h1 class="display-4 fw-bold mb-0">{{ __('Data Pengabdian') }}</h1>
    </div>
...
<section class="py-5 bg-white">
    <div class="container">
        ...
        <div class="filter-card shadow-sm mb-5 p-4 rounded-4 bg-white border border-light">
            <form action="{{ route('community') }}" method="GET" class="row g-3 align-items-end">
                <div class="col-md-6">
                    <label class="form-label small fw-bold text-muted text-uppercase letter-spacing-1">Cari Judul / Pelaksana</label>
                ...
                <div class="col-12 mt-2">
                    <a href="{{ route('community') }}" class="text-danger small fw-bold text-decoration-none">
        ...
        <div class="table-responsive shadow-lg rounded-4 overflow-hidden border-0">
            <table class="table table-hover align-middle mb-0 custom-datatable">
                <thead class="bg-success bg-gradient text-white">
                    <tr>
                        <th class="px-4 py-4" style="width: 50%;">Judul Pengabdian</th>
                        <th class="py-4">Pelaksana</th>
                    ...
                    <tr>
                        <td class="px-4 py-3">
                            <div class="d-flex align-items-center">
                                <div class="icon-box me-3 bg-light text-success">
                        ...
                        <td class="py-3 text-center">
                            <span class="badge bg-soft-success px-3 py-2 rounded-pill text-success fw-bold" style="font-size: 0.8rem;">
                                {{ $post->year ?? '-' }}
                            </span>
                        </td>
                        <td class="px-4 py-3 text-end">
                            <a href="{{ route('research.show', $post->slug) }}" class="btn btn-sm btn-outline-success rounded-pill px-4 hover-up shadow-sm">
                    ...
                    <tr>
                        <td colspan="4" class="text-center py-5">
                            <div class="py-4">
                                ...
                                <h5 class="text-muted fw-bold">Tidak ada data pengabdian ditemukan.</h5>
                            </div>
                        </td>
                    </tr>
                    @endforelse
...
<style>
    ...
    .bg-soft-success { background-color: rgba(40, 167, 69, 0.08); }
