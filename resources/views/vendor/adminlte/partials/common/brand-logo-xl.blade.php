...
<a href="{{ $dashboard_url }}"
    ...
    @php
        ...
        $siteLogoUrl = $siteLogo ? asset('storage/' . $siteLogo) : asset(config('adminlte.logo_img', 'vendor/adminlte/dist/img/AdminLTELogo.png'));
        $siteLogoXlUrl = config('adminlte.logo_img_xl') ? asset(config('adminlte.logo_img_xl')) : $siteLogoUrl;
    @endphp
