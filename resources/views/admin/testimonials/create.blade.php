...
@section('content_header')
    <h1><i class="fas fa-plus me-2"></i>Tambah Testimoni</h1>
@stop
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="batch_year" class="form-control @error('batch_year') is-invalid @enderror" value="{{ old('batch_year') }}" placeholder="Contoh: 2018">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="position" class="form-control @error('position') is-invalid @enderror" value="{{ old('position') }}" placeholder="Contoh: Software Engineer, Founder">
                                @error('position')<span class="invalid-feedback">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Nama Instansi / Perusahaan (Opsional)</label>
                                <input type="text" name="company" class="form-control @error('company') is-invalid @enderror" value="{{ old('company') }}" placeholder="Contoh: PT. ABC Makmur">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body pt-3">
                                <div class="form-group mb-0">
                                    ...
                                    <textarea name="content" class="form-control @error('content') is-invalid @enderror" rows="4" required placeholder="Tuliskan isi testimoni di sini...">{{ old('content') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-5 form-group">
                                ...
                                <select name="rating" class="form-control @error('rating') is-invalid @enderror" required>
                                    <option value="5" {{ old('rating', 5) == 5 ? 'selected' : '' }}>5 Bintang (Sangat Baik)</option>
                                    <option value="4" {{ old('rating') == 4 ? 'selected' : '' }}>4 Bintang (Baik)</option>
                            ...
                            <div class="col-md-7 form-group">
                                ...
                                <small class="text-muted">Disarankan gambar berbentuk kotak (persegi). Maks: 2MB.</small>
                            </div>
                        </div>
