...
@section('content_header')
    <h1><i class="fas fa-plus me-2"></i>Tambah Media Galeri</h1>
@stop
                ...
                <form action="{{ route('admin.gallery.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group" id="photo_input_group">
                            <label>Upload File Foto <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group" id="video_input_group" style="display: none;">
                            ...
                            <input type="url" name="youtube_url" class="form-control @error('youtube_url') is-invalid @enderror" value="{{ old('youtube_url') }}" placeholder="Contoh: https://www.youtube.com/watch?v=...">
                            @error('youtube_url')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>

                        <div class="form-group">
                            <label>Keterangan Tambahan / Caption (Opsional)</label>
                            <textarea name="caption" class="form-control @error('caption') is-invalid @enderror content-editor" rows="5">{{ old('caption') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="album" class="form-control @error('album') is-invalid @enderror" value="{{ old('album') }}" placeholder="Contoh: Wisuda 2024">
