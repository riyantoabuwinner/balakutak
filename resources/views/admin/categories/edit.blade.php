...
@section('content_header')
    <h1><i class="fas fa-edit me-2"></i>{{ __('admin.edit_category') }}</h1>
@stop
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="color" name="color" class="form-control @error('color') is-invalid @enderror" value="{{ old('color', $category->color ?? '#007bff') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" placeholder="fas fa-tag" value="{{ old('icon', $category->icon) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Order</label>
                                    <input type="number" name="order" class="form-control @error('order') is-invalid @enderror" value="{{ old('order', $category->order ?? 0) }}">
