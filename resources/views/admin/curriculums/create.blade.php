...
@section('content_header')
    <h1><i class="fas fa-plus me-2"></i>Tambah Mata Kuliah</h1>
@stop
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" required placeholder="Contoh: IF1234">
                                @error('code')<span class="invalid-feedback">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-8 form-group">
                                <label>Nama Mata Kuliah <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="Contoh: Algoritma dan Pemrograman">
                        ...
                        <div class="row">
                            <div class="col-md-3 form-group">
                                ...
                                <input type="number" name="semester" class="form-control @error('semester') is-invalid @enderror" value="{{ old('semester') }}" min="1" max="14" required>
                                @error('semester')<span class="invalid-feedback">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group">
                                <label>SKS <span class="text-danger">*</span></label>
                                <input type="number" name="credits" class="form-control @error('credits') is-invalid @enderror" value="{{ old('credits') }}" min="0" max="10" required>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" name="concentration" class="form-control @error('concentration') is-invalid @enderror" value="{{ old('concentration') }}" placeholder="Contoh: Rekayasa Perangkat Lunak">
                        ...
                        <div class="form-group border-top pt-3 mt-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" placeholder="Capaian pembelajaran mata kuliah ini adalah...">{{ old('description') }}</textarea>
                        ...
                        <div class="row bg-light border p-3 rounded mt-3">
                            <div class="col-md-7">
                                <div class="form-group mb-0">
                                    <label>Upload File RPS / Silabus (Opsional)</label>
                                    ...
                                    <small class="text-muted d-block mt-1">Format: PDF, Word. Maks: 5MB.</small>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group mb-0">
        ...
        <div class="col-md-3">
            <div class="card card-outline card-info">
                ...
                <div class="card-body text-sm text-muted">
                    <p>Silakan isi informasi mata kuliah dengan lengkap. Data ini akan ditampilkan di halaman akademik program studi.</p>
                    <p>Pastikan <strong>Kode Mata Kuliah</strong> sesuai dengan pedoman akademik.</p>
                    <p>Anda dapat mengunggah file <strong>RPS (Rencana Pembelajaran Semester)</strong> agar mahasiswa dapat mengunduhnya.</p>
                </div>
            </div>
        </div>
    </div>
